function LoginPage() {
  return (
    ...
    >
      {/*form section*/}
      <form className="absolute left-1/2 -translate-x-1/2 -bottom-1/4 bg-[#FAFAFC] dark:bg-gray-800 w-[42rem] rounded-t-lg p-16">
        <h3 className="text-xl font-semibold mb-4 text-center md:text-left text-[#32264D] dark:text-white">
          BLOG FORM
        </h3>
        <div className="mb-4">
