    ...
    return (
        <div className="max-w-[820px] w-full mx-auto px-5">
            ...
            <div className="w-full mt-6">
                ...
                <p className="mt-3 font-SourceSerif text-sm md:text-base lg:text-lg/6 font-normal text-[#3B3C4A]">
            ...
            <div className="w-full mt-8">
                ...
                <p className="mt-3 text-sm md:text-base font-SourceSerif lg:text-lg/6 font-normal text-[#3B3C4A]">
            ...
            <div className="w-full mt-8">
                ...
                <p className="mt-3 text-sm font-SourceSerif md:text-base lg:text-lg/6 font-normal text-[#3B3C4A]">
